...
| **P2** | **Zero Hardcoding** | No brand names, product IDs, category slugs, collection IDs, content image URLs, prices, or text blocks in HTML/JS. **EXCEPTION:** Purely structural UI assets (inline SVGs, icons, CSS patterns) from the mockup MUST be preserved. |
