...
// ─────────────────────────────────────────────────────────────────────────────
// SECTION 1 — DYNAMIC DATA LOOKUP
//
// Reads mock data injected via window.__DEV_PRODUCTS__ and window.__DEV_CONFIGS__.
// Falls back to empty arrays/objects if not declared.
// ─────────────────────────────────────────────────────────────────────────────

const DEV_PRODUCTS = window.__DEV_PRODUCTS__ || [];
const DEV_CONFIGS  = window.__DEV_CONFIGS__  || {};
